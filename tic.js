...
function Board (options){
  ...
  function render(){
    ...
    function htmlQ1(){
      return `<div id="view1"><h3>Menu\n</h3>
      ${buttonHTML(1, "1player", "Man Vs computer")}
      ${buttonHTML(1, "2players", "Man Vs Man")}
      </div>`
    }

    function htmlQ2(){
      const html2=`<div id="view2"><h3>${!state.players[1].isComputer? "Player 1, <br />" : ""}Mau Pake simbol Apa?</h3>
      ${buttonHTML(2, "X", "X")}
      ${buttonHTML(2, "O", "O")}`
      return html2
    }
